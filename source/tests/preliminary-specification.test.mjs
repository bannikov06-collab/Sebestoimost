...
test("commercial length classes use confirmed defaults", () => {
  assert.deepEqual(inferCommercialLength("KLM-S-25-Cu-55-4-V3-FE-S1"), { lengthClass: "S1", lengthMm: 750 });
...
test("preliminary specification form is parsed without production-order headers", () => {
  const matrix = [
